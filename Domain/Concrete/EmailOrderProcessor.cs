...
namespace Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAdress = "autostore@example.com";
        ...
        public string FileLocation = @"D:\University\WEB\AutoStore\Mails";
    }
  public   class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Entities.Cart cart,Entities.ShippingDetails shippingDetails)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Auto.Price * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2}$ ",
                        line.Quantity, line.Auto.Name, subtotal);
                }
